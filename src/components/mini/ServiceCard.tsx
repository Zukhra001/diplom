...
const ServiceCard = ({title, image}: {title: string, image: string}) => {
    return (
        <div className='bg-white flex flex-col items-center justify-center gap-4 p-4 rounded-md shadow-md shadow-gray-300 hover:shadow-lg hover:shadow-gray-400 hover:border-b-2 hover:border-b-[#FF9100] transition-all duration-300'>
